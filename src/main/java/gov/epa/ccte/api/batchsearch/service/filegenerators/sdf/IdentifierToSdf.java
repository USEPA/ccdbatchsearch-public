...
@Slf4j
public class IdentifierToSdf extends SdfBase implements ExportType {
    ...
    public byte[] export() {
        ...
        HashMap<String, List<SearchWithChemicalDetails>> chemicals = identifierSearch.getResults(searchForm);
