...
@Slf4j
public class ExactFormulaSearch implements SearchType {
    ...
    public List<ChemicalDetails> getChemicals(BatchSearchForm formBean) {
        ...
        //return searchWithChemicalDetailsRepository.getChemicalsForFormula(formBean.getSearchItems().split("\n"));
        return detailsRepository.searchFormulas(formBean.getSearchItems().split("\n"));
    }
    ...
    public HashMap<String, List<SearchWithChemicalDetails>> getResults(BatchSearchForm formBean) {
        ...
        for (SearchWithChemicalDetails details : searchWithChemicalDetailsRepository.getChemicalsForFormula(formBean.getSearchItems().split("\n"))) {
